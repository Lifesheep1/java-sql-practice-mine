...
public class Part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO users (username,email,password) VALUE ('yang','yy@naver.com','1234')";
  ...
  */
  public static final String PART2_10 = "insert into posts (user_id,title,content) values (1,'dd','qe')";
  ...
  */
  public static final String PART2_12 = "select p.title from posts p join users u on u.user_id = p.user_id where u.user_id = 1";
  ...
  */
  public static final String PART2_13 = "select b.name from boards b " +
          "join posts p on p.board_id = b.board_id join users u on u.user_id = p.user_id " +
          "where u.user_id = 1";
  ...
  */
  public static final String PART2_15 = "select count(content) as CommentCount from comments c " +
  ...
  */
  public static final String PART2_16 = "select u.user_id, count(content) as CommentCount from comments c " +
          "join users u on u.user_id = c.user_id " +
          "group by u.user_id";
  /*
  ----------------------------------------------------------------------------------------------
  ...
  */
  public static final String PART2_17 = "select b.name, count(content) as PostCount from posts p " +
          "join boards b on p.board_id = b.board_id " +
          "group by b.name";
  ...
  */
  public static final String PART2_18 = "select b.name, avg(char_length(content)) as AvgLength from boards b " +
  ...
  */
  public static final String PART2_19 = "select b.name, avg(char_length(content)) as AvgLength from boards b " +
          "left join posts p on b.board_id = p.board_id " +
          "group by b.name " +
  ...
  */
  public static final String PART2_20 = "select t.name, count(p.content) as PostCount from tags t " +
